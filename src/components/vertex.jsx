...
import { Dimensions, Coords, convert, IN, OUT }  from '../model';
import { VertexMeasured, PortMeasured, VertexMoved, Rendered, model as eventsModel }  from '../events';
import * as shallowEqual from '../util/shallow-equal';
import * as options from '../util/options';

const { VertexMeasurements } = eventsModel;
